...
class GameState:
    ...
    def __init__(self):
        ...
        # 游戏界面标题
        pygame.display.set_caption('NOOB 5 Actions 20Million Steps')
        # 飞机及子弹图片集合
    ...
    def frame_step(self, input_actions):
        ...
        if input_actions[0] == 1 or input_actions[1]== 1 or input_actions[2]== 1 or input_actions[3]== 1 or input_actions[4]== 1:  # 检查输入正常
            if input_actions[0] == 0 and input_actions[1] == 1 and input_actions[2] == 0 and input_actions[3]== 0 and input_actions[4]== 0:
                self.player.moveLeft()
            elif input_actions[0] == 0 and input_actions[1] == 0 and input_actions[2] == 1 and input_actions[3]== 0 and input_actions[4]== 0:
                self.player.moveRight()
            elif input_actions[0] == 0 and input_actions[1] == 0 and input_actions[2] == 0 and input_actions[3]== 1 and input_actions[4]== 0:
                self.player.moveUp()
            elif input_actions[0] == 0 and input_actions[1] == 0 and input_actions[2] == 0 and input_actions[3]== 0 and input_actions[4]== 1:
